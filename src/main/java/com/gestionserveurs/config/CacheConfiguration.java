package com.gestionserveurs.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("GestionServeurs");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("GestionServeurs");
        ...
        config.getMapConfigs().put("com.gestionserveurs.domain.*", initializeDomainMapConfig(jHipsterProperties));
